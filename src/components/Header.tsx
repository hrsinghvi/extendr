            ...
            {isAuthenticated && user ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent sideOffset={8} className="w-60 bg-[#0C1111] text-white border border-[#2a2a2a] rounded-lg shadow-lg p-2">
                  ...
                  <DropdownMenuItem onSelect={async () => { await supabase.auth.signOut(); navigate('/'); }} className="flex items-center gap-2 px-3 py-2 cursor-pointer hover:bg-[#1a1a1a] rounded-md">

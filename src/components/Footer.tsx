        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-black">Bolt</span>
            </div>
          </div>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="font-semibold mb-4 text-black">{category}</h3>
          ...
          {/* Social column */}
          <div>
            <h3 className="font-semibold mb-4 text-black">Social</h3>
            <ul className="space-y-3">
